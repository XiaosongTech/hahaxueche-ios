...
- (void)initSubviews {
    ...
    self.loginButton = [self createBorderButtonWithTitle:NSLocalizedString(@"登陆",nil) textColor:[UIColor whiteColor] font:[UIFont fontWithName:@"STHeitiSC-Light" size:18] action:@selector(login)];
