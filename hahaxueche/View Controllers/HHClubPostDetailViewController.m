...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem buttonItemWithImage:[UIImage imageNamed:@"ic_mycoach_sharecoach"] action:@selector(sharePost) target:self];
    self.view.backgroundColor = [UIColor whiteColor];
