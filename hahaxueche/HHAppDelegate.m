...
//
//        } else {
//            [[HHUserAuthenticator sharedInstance] fetchAuthedCoachWithId:[HHUserAuthenticator sharedInstance].currentCoach.coachId completion:^(HHCoach *coach, NSError *error) {
//                if (!error) {
