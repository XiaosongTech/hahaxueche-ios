...
- (void)autoLayoutSubviews {
    NSArray *constraints = @[
                             ...
                             [HHAutoLayoutUtility verticalAlignToSuperViewTop:self.timeLabel constant:10.0f],
                             [HHAutoLayoutUtility horizontalAlignToSuperViewLeft:self.timeLabel constant:10.0f],
