...
- (void)initSuviews {
    ...
    self.nameLabel = [self createLabelWithTitle:nil font:[UIFont fontWithName:@"SourceHanSansCN-Medium" size:13] textColor:[UIColor blackColor]];
    self.ratingLabel = [self createLabelWithTitle:[self.review.rating stringValue] font:[UIFont fontWithName:@"SourceHanSansCN-Medium" size:13] textColor:[UIColor HHOrange]];
