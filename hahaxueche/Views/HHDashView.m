...
- (instancetype)initWithValueTextColor:(UIColor *)textColor rightLine:(BOOL)rightLine {
    ...
    if (self) {
        ...
        self.keyLabel = [self createLabelWithFont:[UIFont fontWithName:@"SourceHanSansSC-Medium" size:12.0f] textColor:kKeyTextColor];
        self.valueLabel = [self createLabelWithFont:[UIFont fontWithName:@"SourceHanSansSC-Medium" size:15.0f] textColor:textColor];
        if (rightLine) {
