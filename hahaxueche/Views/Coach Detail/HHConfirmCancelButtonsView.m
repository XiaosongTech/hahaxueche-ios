...
- (instancetype)initWithLeftTitle:(NSString *)leftTitle rightTitle:(NSString *)rightTitle {
    ...
    if (self) {
        ...
        [self.leftButton setTitleColor:[UIColor HHConfirmGreen] forState:UIControlStateNormal];
        [self.leftButton setTitle:leftTitle forState:UIControlStateNormal];
        [self addSubview:self.leftButton];
        
        self.rightButton = [UIButton buttonWithType:UIButtonTypeCustom];
        self.rightButton.titleLabel.font = [UIFont systemFontOfSize:15.0f];
        [self.rightButton setTitleColor:[UIColor HHCancelRed] forState:UIControlStateNormal];
